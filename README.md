...
🚧 Fases 0 a 7 concluídas (fundação do monorepo, Google Maps Search Engine, Coletor + Analisador de Website, Opportunity Score, Gerador de Website + Deploy, Fila de Aprovação Manual, WhatsApp, CRM + Dashboard) — ver [`ROADMAP.md`](./ROADMAP.md). Ainda pendente: validar as fases com credenciais/infra reais (Google billing, Redis, Anthropic, GitHub/Vercel, template do WhatsApp aprovado na Meta) — ver `TODO.md`.
